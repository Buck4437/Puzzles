var app = new Vue({
    ...
    data: {
        title: "Line",
        answer: "CARVING TOOL",
        text: `Start at the station that is also on the Sub-Central line. Towards the direction with increasing station number, ride until the next stop has a smaller number than the current stop. Ride 2 more stop along the same direction. Read the first letter.
        ...
        Start at the busiest station. Ride 1 stop to a station that starts with a T.  Exit the train. Enter the train. Ride 38 stops. Read the seventh letter.
        Start at the station whose translated name is "Avenue of the Americas". Ride 14 stops. Read the sixth letter.
